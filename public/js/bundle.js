...
var displayMap = exports.displayMap = function displayMap(x) {
  var _x$0$coordinates = _slicedToArray(x[0].coordinates, 2),
    lat = _x$0$coordinates[0],
    lng = _x$0$coordinates[1];
  var map = L.map('map', {
  ...
  var marker = function marker(el) {
    var _el$coordinates = _slicedToArray(el.coordinates, 2),
      x = _el$coordinates[0],
      y = _el$coordinates[1];
    var marker = L.marker([y, x], {
      ...
      minWidth: 100,
      autoClose: false
    })).setPopupContent("Day ".concat(el.day, ": ").concat(el.description)).openPopup();
  };
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var stripe = Stripe('pk_test_51OSa9PSGm1wRyuQ7JqVhxIUEvRwLVfF5KL7HtLUNlE2QHgziBaN7EQooqMmOQbSdA797zt1C4BKJSjYDJlSqCDHk00rB6CzN7t');
...
var updatePasswordBtn = document.querySelector('.btn--save-password');
